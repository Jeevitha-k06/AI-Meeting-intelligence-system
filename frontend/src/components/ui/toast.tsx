  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        variant === "success" &&
          "border-green-500/20 bg-green-950/80 text-green-100",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border border-white/10 bg-transparent px-3 text-sm font-medium transition-colors hover:bg-white/10 focus:outline-none disabled:pointer-events-none disabled:opacity-50",
      className
    )}
    {...props}
  />
